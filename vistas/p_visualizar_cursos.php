            ...
            <div class="box">
                <?php if (empty($cursos_profesor)): ?>
                    <div class="notification is-info is-light">
                        ...
                        <p class="mt-2">Puede <a href="index.php?vista=curso_crear_formulario">crear un nuevo curso aquí</a>.</p>
                    </div>
                <?php else: ?>
                ...
                <?php endif; ?>
                 <div class="mt-5 has-text-centered">
                    <a href="index.php?vista=curso_crear_formulario" class="button is-link">
