<?php
// procesos/cursos/procesar_curso.php (antes procesar_creacion.php)

require_once __DIR__ . "/../../inc/session_start.php"; // Ajusta si la profundidad cambió
require_once __DIR__ . "/../../php/main.php";         // Ajusta si la profundidad cambió
...
if ($_SERVER['REQUEST_METHOD'] !== 'POST') {
    ...
    // CORRECCIÓN: Ruta de redirección
...
$id_profesor = limpiar_cadena($_POST['id_profesor'] ?? '');
...
try {
    ...
    $stmt_insert_curso->bindParam(':cupo_maximo', $cup_maximo, PDO::PARAM_INT);
